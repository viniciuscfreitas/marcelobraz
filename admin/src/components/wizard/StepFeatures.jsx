...
export default function StepFeatures() {
    ...
    const CheckboxGroup = ({ title, items, prefix }) => (
        <div className="space-y-3">
            <h4 className="font-medium text-gray-900 text-sm uppercase tracking-wide">{title}</h4>
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <section className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900 border-b border-gray-100 pb-2">Características Gerais</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label htmlFor="posicao_apto" className="block text-sm font-medium text-gray-700 mb-1">Posição do Imóvel</label>
                    ...
                    <div>
                        <label htmlFor="andares" className="block text-sm font-medium text-gray-700 mb-1">Andares</label>
            ...
            <section className="space-y-6">
                <h3 className="text-lg font-semibold text-gray-900 border-b border-gray-100 pb-2">Áreas Comuns e Lazer</h3>
                <CheckboxGroup
            ...
            {/* Áreas Privativas */}
            <section className="space-y-6">
                <h3 className="text-lg font-semibold text-gray-900 border-b border-gray-100 pb-2">Áreas Privativas</h3>
                <CheckboxGroup
